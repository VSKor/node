...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = new _Node2.default();
	document.body.appendChild(NodeX.DOMNodes[Main.nid]);
	
	Main.append(new _Table2.default({
	  className: 'some',
	  head: [["a", "b", "c"]],
	...
	var Node = function () {
	  ...
	  (0, _createClass3.default)(Node, [{
	    ...
	    value: function createElement() {
	      ...
	      return (0, _assign2.default)(node, props);
	    }
	  }, {
	    key: "append",
	    value: function append(appendNode, callback) {
	      var nid = NodeX.Nodes.indexOf(appendNode) || NodeX.DOMNodes.indexOf(appendNode);
	      if (nid === -1) {
	        var newNode = new Node(appendNode);
	        nid = newNode.nid;
	      }
	      var appendedNode = newNode || NodeX.Nodes[nid];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Table = function (_Node) {
	  (0, _inherits3.default)(Table, _Node);
	
	  function Table() {
	    var props = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
	    (0, _classCallCheck3.default)(this, Table);
	
	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Table).call(this, (0, _assign2.default)(props, {
	      element: 'table'
	    })));
	
	    var tableParts = ['head', 'body', 'foot'];
	    for (var i in tableParts) {
	      var part = tableParts[i];
	      if (props[part]) {
	        _this.addTablePart.call(_this, part, props[part]);
	      }
	    }
	    return _this;
	  }
	  ...
	  (0, _createClass3.default)(Table, [{
	    ...
	    key: 'addTablePart',
	    value: function addTablePart(part, data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(17)(IteratorPrototype, __webpack_require__(71)('iterator'), function(){ return this; });
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(15)(Function.call, __webpack_require__(87).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
